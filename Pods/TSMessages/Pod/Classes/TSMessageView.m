...
+ (NSMutableDictionary *)notificationDesign
{
    ...
    {
        /* Issue: <Error>: *** Terminating app due to uncaught exception 'NSInternalInconsistencyException', reason: 'Could not read TSMessages config file from main bundle with name TSMessagesDefaultDesign.json'
         * This happens on iOS 9
         * Apply Workaround solution:
         * https://github.com/KrauseFx/TSMessages/issues/257
         * https://github.com/svlaev/TSMessages/blob/master/Pod/Classes/TSMessageView.m#L148
         */
